...
export const metadata = {
    alternates: {
        canonical: "https://volturaprojects.es/energia-fotovoltaica",
        languages: {
        ...
        <main className="min-h-screen bg-voltura-blue text-voltura-stone font-sans selection:bg-voltura-gold selection:text-white">
                            ...
                            "itemListElement": [
                                {
                                    ...
                                    "priceCurrency": "EUR",
                                    "price": "0",
                                    "description": "Análisis de viabilidad solar y presupuesto detallado para sistemas de autoconsumo premium."
                                }
                            ]
                        },
                        "aggregateRating": {
            ...
            <section id="contacto" className="py-24 bg-gradient-to-b from-voltura-blue to-voltura-slate">
                <div className="max-w-5xl mx-auto px-4 text-center">
                    <h2 className="text-4xl font-serif text-white mb-6">Presupuesto de Energía Fotovoltaica en Barcelona</h2>
