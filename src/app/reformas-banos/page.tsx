...
export const metadata = {
    alternates: {
        canonical: "https://volturaprojects.es/reformas-banos",
        languages: {
                            ...
                            "itemListElement": [
                                {
                                    ...
                                    "priceCurrency": "EUR",
                                    "price": "0",
                                    "description": "Estudio y presupuesto sin compromiso para proyectos de baño de alta gama."
                                }
                            ]
                        },
                        "aggregateRating": {
