...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
    ...
    const staticPages = [
        ...
        {
            url: `${baseUrl}/rehabilitacion-activos-inmobiliarios`,
            lastModified: new Date(),
    ...
    // Static project pages from data folder
    ...
    try {
        ...
        console.error("Error fetching projects for Spanish sitemap:", e);
    }
    ...
    return [...staticPages, ...projectPagesStatic, ...projectPagesDb, newsLandingPage, ...articlePages];
}
